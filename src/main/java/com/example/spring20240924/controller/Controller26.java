...
public class Controller26 {
    ...
    //상품명 검색하는 코드 작성
    @GetMapping("sub4")
    public void sub4(Model model, @RequestParam(value = "keyword", defaultValue = "") String keyword) throws Exception {
        String sql = STR."""
                SELECT *
                FROM Products
    ...
    @GetMapping("sub5")
    public void sub5(@RequestParam(defaultValue = "0") String min,
                     @RequestParam(defaultValue = "20000") String max,
