...
public class Controller18 {
    ...
    @RequestMapping("sub1")
    public String sub1() {
        // redirect(redirection) : 다른곳으로 가라는 응답
        // 브라우저는 이 응답을 받으면 새 요청을 보낸다.

        System.out.println("Controller.sub1");
        //이 경로로 다시 요청보내라는 응답
    ...
    @RequestMapping("sub2")
    public String sub2() {
        System.out.println("Controller.sub2");
    ...
    public String sub3() {
        ...
        return "redirect:/main18/sub4?name=son&age=44"; /*request parameter*/
    }
...
//        2. session attribute 이용방법
    ...
    public String sub9(RedirectAttributes rttr) {
        ...
        // RedirectionAttribute 객체의 addFlashAttribute 메소드 사용할 것
        rttr.addFlashAttribute("foodList", List.of("pizza", "burger", "coffe"));
