...
public class Controller38 {
    ...
    @GetMapping("sub6")
    public void sub6(Employee employee) {
    ...
    public void method12() {
        ...
        //employee 속성
        employee.setLastName("흥민");
        employee.setFirstName("손");
        employee.setBirthDate(LocalDate.parse("1991-01-01"));
        employee.setPhoto("1.jpg");
        employee.setNotes("하이");
